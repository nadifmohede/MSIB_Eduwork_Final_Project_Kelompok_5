      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="proses_tambah_aktor.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group pb-3">
                            ...
                            <input type="" id="date1" name="tanggal_lahir" class="form-control" placeholder="Masukkan Tanggal Lahir Aktor">
                        </div>
                        <div class="form-group pb-3">
                        ...
                        <div class="form-group pb-3">
                            ...
                            <textarea class="form-control" rows="5" name="biografi" placeholder="Masukkan Biografi Aktor"></textarea>
                        </div>
                        <div class="form-group pb-3">
