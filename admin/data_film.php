                ...
                <table id="datatablesSimple">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_film.php?id=<?php echo $data['id_film']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_film.php?id=<?php echo $data['id_film']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
