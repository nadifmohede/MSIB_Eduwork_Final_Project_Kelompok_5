      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Tambah Data Reviewer</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="index-admin.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Tambah Data Reviewer</li>
            </ol>
            <div class="card mb-4">
              <div class="card-body">
                Silahkan isi data dibawah untuk menambahkan data reviewer.
              </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="proses_tambah_reviewer.php" method="post">
                        <div class="form-group pb-3">
                            <label>Nama User</label>
                            <select name="id_user" class="form-control">
                                <option disabled selected>--PILIH SALAH SATU--</option>
                                <?php 
                                $sql = mysqli_query($koneksi, "SELECT id, nama FROM users ORDER BY nama ASC");
                        ...
                        <div class="form-group pb-3">
                            ...
                            <input type="text" name="nama_reviewer" class="form-control" placeholder="Masukkan Nama Reviewer">
                        </div>
                        <div class="form-group pb-3">
