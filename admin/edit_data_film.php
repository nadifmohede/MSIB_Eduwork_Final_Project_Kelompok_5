      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                <form action="edit_data_film.php" method="post">
              ...
              <div class="form-group  pb-3">
                ...
                <input type="datet" name="tahun_rilis" class="form-control" placeholder="Masukkan Tahun Rilis">
              </div>
              <div class="form-group pb-3">
                <label>Tanggal Rilis</label>
                <input type="date" name="tanggal_rilis" class="form-control" placeholder="Masukkan Tanggal Rilis">
              </div>
              <div class="form-group pb-3">
