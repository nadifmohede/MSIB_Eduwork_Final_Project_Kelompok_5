      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="proses_edit_sutradara.php?id_sutradara=<?php echo $sutradara['id_sutradara']; ?>" method="post">
                        <div class="form-group pb-3">
                            <label>Nama Sutradara</label>
                            <input type="hidden" name="id_sutradara" value="<?php echo $id_sutradara; ?>">
                            <input type="text" name="nama_sutradara" value="<?php echo $nama_sutradara; ?>" class="form-control">
                        </div>
                        <div class="form-group pb-3">
