      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data sutradara dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_sutradara.php" class="btn btn-primary">Tambah Data Sutradara</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class=" DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    $no=0;
                    $query = mysqli_query($koneksi, "SELECT * FROM sutradara; ");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_sutradara.php?id_sutradara=<?php echo $data['id_sutradara']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_sutradara.php?id_sutradara=<?php echo $data['id_sutradara']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
