<?php
    ...
    $result = mysqli_query($koneksi, "UPDATE aktor SET nama_aktor = '$nama_aktor', tanggal_lahir = '$tanggal_lahir', jenis_kelamin = '$jenis_kelamin', negara_asal = '$negara_asal', biografi = '$biografi', file_gambar = '$nama_file' WHERE id_aktor = '$id_aktor' ");
