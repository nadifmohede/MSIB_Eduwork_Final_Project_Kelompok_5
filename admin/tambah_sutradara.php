      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Tambah Data Sutradara</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="index-admin.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Tambah Data Sutradara</li>
            </ol>
            <div class="card mb-4">
              <div class="card-body">
                ...
                <div class="card-body">
                    <form action="proses_tambah_sutradara.php" method="post">
                        <div class="form-group pb-3">
                            ...
                            <input type="text" name="nama_sutradara" class="form-control" placeholder="Masukkan Nama Sutradara">
                        </div>
                        <div class="form-group pb-3">
