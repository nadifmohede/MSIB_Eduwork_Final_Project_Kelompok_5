                ...
                <div class="card-body">
                    <form action="proses_tambah_pemeran.php" method="post">
                        <div class="form-group pb-3">
                            ...
                            <input type="text" name="id_aktor" class="form-control" placeholder="Masukkan Nama Sutradara">
                        </div>
                        <div class="form-group pb-3">
                            <label>Id Film</label>
                            <input type="text" name="id_film" class="form-control" placeholder="Masukkan Nama Sutradara">
                        </div>
                        <div class="form-group pb-3">
                            <label>Peran</label>
                            <input type="text" name="peran" class="form-control" placeholder="Masukkan Nama Sutradara">
                        </div>
                        <div class="form-group pb-3">
