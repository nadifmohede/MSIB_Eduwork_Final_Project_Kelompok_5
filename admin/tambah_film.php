  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
          <div class="card-body">
            Silahkan isi data dibawah untuk menambahkan data film.
          </div>
        </div>
          ...
          <div class="card-body">
            <form action="proses_tambah_film.php" method="post">
              <div class="form-group">
                ...
                <input type="text" name="id_sutradara" class="form-control" placeholder="Masukkan Id Sutradara">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sinopsis" class="form-control" placeholder="Masukkan sinopsis">
              </div>
              <div class="form-group">
                <label>Tahun Rilis</label>
                <input type="datetime" name="tahun_rilis" class="form-control" placeholder="Masukkan Tahun Rilis">
              </div>
              <div class="form-group">
                <label>Tanggal Rilis</label>
                <input type="date" name="tanggal_rilirs" class="form-control" placeholder="Masukkan Tanggal Rilis">
              </div>
              <div class="form-group">
                <label>Durasi Film</label>
                <input type="text" name="durasi_film" class="form-control" placeholder="Masukkan Durasi Film">
              </div>
              <div class="form-group">
