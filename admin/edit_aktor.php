...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            $data_aktor =mysqli_query($koneksi, "SELECT * FROM aktor WHERE id_sutradara = '$id_sutradara' ");
                    ...
                    <div class="card-body">
                        <form action="edit_proses_sutradara.php" method="post">
                            <div class="form-group pb-3">
                                ...
                                <input type="text" name="nama_aktor" class="form-control"
                                    placeholder="Masukkan Nama Aktor">
                            </div>
                            <div class="form-group pb-3">
                                <label>Tanggal Lahir</label>
                                <input type="date" name="tanggal_lahir" class="form-control"
                                    placeholder="Masukkan Tanggal Lahir Aktor">
                            </div>
                            <div class="form-group pb-3">
                            ...
                            <div class="form-group pb-3">
                                ...
                                <input type="text" name="negara_asal" class="form-control"
                                    placeholder="Masukkan Negara Asal Aktor">
                            </div>
                            <div class="form-group pb-3">
                                <label>Biografi</label>
                                <input type="text" name="biografi" class="form-control"
                                    placeholder="Masukkan Biografi Aktor">
                            </div>
                            <div class="form-group pb-3">
                                <label>File Foto</label>
                                <input type="file" name="file_gambar" class="form-control"
                                    placeholder="Masukkan File Foto Aktor">
                            </div>
                            <div class="form-group pb-3">
