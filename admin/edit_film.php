    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit Data Sutradara</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item">
                        <a href="index-admin.php">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Data Sutradara</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                        Silahkan isi data dibawah untuk mengedit data sutradara.
                    </div>
                </div>
                <div class="col text-right">
                    <a href="data_sutradara.php" class="btn btn-dark">Kembali ke Data Sutradara</a>
                    <br><br>
                </div>
            ...
            $data_sutradara =mysqli_query($koneksi, "SELECT * FROM sutradara WHERE id_sutradara = '$id_sutradara' ");
            ...
            ?>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="edit_proses_sutradara.php" method="post">
                            <div class="form-group pb-3">
                                <label>Id Sutradara</label>
                                <input type="text" name="nama_sutradara" value="<?php echo $nama_sutradara; ?>"
                                    class="form-control" placeholder="Masukkan Nama Sutradara">
                            </div>
                            <div class="form-group pb-3">
                                <label>Id Genre</label>
                                <input type="text" name="id_genre" class="form-control" placeholder="Masukkan Id Genre">
                            </div>
                            <div class="form-group  pb-3">
                            ...
                            <div class="form-group pb-3">
                                ...
                                <textarea class="form-control" rows="5" name="sinopsis"
                                    placeholder="Masukkan sinopsis"></textarea>
                            </div>
                            <div class="form-group  pb-3">
                                <label>Tahun Rilis</label>
                                <input type="datet" name="tahun_rilis" class="form-control"
