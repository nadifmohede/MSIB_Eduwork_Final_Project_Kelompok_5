                ...
                <table class="text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_komentar.php?id=<?php echo $data['id_komentar']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_komentar.php?id=<?php echo $data['id_komentar']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
