      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data komentar dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_komentar.php" class="btn btn-primary">Tambah Data Komentar</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    $no=0;
                    $query = mysqli_query($koneksi, "SELECT film.judul_film, reviewer.nama_reviewer, komentar.id_komentar, komentar.rating, komentar.isi_komentar
                    FROM film
                    INNER JOIN komentar ON film.id_film = komentar.id_film
                    INNER JOIN reviewer ON komentar.id_reviewer = reviewer.id_reviewer; ");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_komentar.php?id_komentar=<?php echo $data['id_komentar']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_komentar.php?id_komentar=<?php echo $data['id_komentar']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
