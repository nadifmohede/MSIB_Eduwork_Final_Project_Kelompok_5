                ...
                <table class="text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_reviewer.php?id=<?php echo $data['id_reviewer']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_reviewer.php?id=<?php echo $data['id_reviewer']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
