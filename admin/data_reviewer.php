      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Data Reviewer</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="index-admin.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Data Reviewer</li>
            </ol>
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data reviewer dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_reviewer.php" class="btn btn-primary">Tambah Data Reviewer</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    $no=0;
                    $query = mysqli_query($koneksi, "SELECT reviewer.id_reviewer, reviewer.nama_reviewer, users.id, users.nama
                    FROM reviewer
                    INNER JOIN users ON reviewer.id_user = users.id; ");
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_reviewer.php?id_reviewer=<?php echo $data['id_reviewer']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_reviewer.php?id_reviewer=<?php echo $data['id_reviewer']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
