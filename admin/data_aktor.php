      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data aktor dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_aktor.php" class="btn btn-primary">Tambah Data Aktor</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      <td><?php echo $no?></td>
                      <td><?php echo $data['id_aktor']?></td>
                      <td><?php echo "<img src='../images/aktor/$data[file_gambar]' height='200' />";?></td>
                      <td><?php echo $data['nama_aktor']?></td>
                      <td><?php echo $data['tanggal_lahir']?></td>
                      <td><?php echo $data['jenis_kelamin']?></td>
                      <td><?php echo $data['negara_asal']?></td>
                      <td><?php echo substr($data['biografi'], 0, 75) . " [...]" ?></td>
                      <td>
                        <a href="edit_data_aktor.php?id_aktor=<?php echo $data['id_aktor']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_aktor.php?id_aktor=<?php echo $data['id_aktor']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
