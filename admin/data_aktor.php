                ...
                <table class="text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_aktor.php?id=<?php echo $data['id_sutradara']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_aktor.php?id=<?php echo $data['id_sutradara']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
