                ...
                <table class="text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_rating.php?id=<?php echo $data['id_rating']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_rating.php?id=<?php echo $data['id_rating']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
