      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data rating film dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_rating.php" class="btn btn-primary">Tambah Data Rating</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    "SELECT komentar.rating, film.judul_film
                    FROM komentar
                    JOIN film ON komentar.id_film = film.id_film
                    JOIN rating ON film.id_film = rating.id_film; ");
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php
                          $query = "SELECT AVG(komentar.rating) AS rata_rating FROM komentar JOIN film ON komentar.id_film = film.id_film WHERE film.judul_film = '$data[judul_film]'; ";
                      ...
                      <td>
                        <a href="delete_data_rating.php?id_rating=<?php echo $data['id_rating']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
