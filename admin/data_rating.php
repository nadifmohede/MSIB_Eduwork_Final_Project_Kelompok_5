      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data rating dari database blockbuster movie.
              </div>
            </div>
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    $no=0;
                    $query = mysqli_query($koneksi, "SELECT * FROM rating; ");
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $data['nilai_rating']?></td>
                      <td>
                        <a href="edit_data_rating.php?id_rating=<?php echo $data['id_rating']; ?>" class="btn btn-warning">Edit</a>
