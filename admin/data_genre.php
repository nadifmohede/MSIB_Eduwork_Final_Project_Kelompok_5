      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-body">
                Berikut ini adalah data genre dari database blockbuster movie.
              </div>
            </div>
            <div class="col text-right">
                  <a href="tambah_genre.php" class="btn btn-primary">Tambah Data Genre</a>
                  <br><br>
            </div>
            <div class="card mb-4">
                ...
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_genre.php?id_genre=<?php echo $data['id_genre']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_genre.php?id_genre=<?php echo $data['id_genre']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
