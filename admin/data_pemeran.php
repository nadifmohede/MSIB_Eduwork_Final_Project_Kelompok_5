                ...
                <table class="text-center" id="datatablesSimple">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_pemeran.php?id=<?php echo $data['id_pemeran']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_pemeran.php?id=<?php echo $data['id_pemeran']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
