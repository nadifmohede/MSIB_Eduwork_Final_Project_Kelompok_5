        ...
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="col text-right">
                  <a href="tambah_pemeran.php" class="btn btn-primary">Tambah Data Pemeran</a>
                  <br><br>
            </div>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <table class="DataTable text-center" id="datatablesSimple">
                  ...
                  <?php
                    ...
                    $no=0;
                    $query = mysqli_query($koneksi, "SELECT aktor.nama_aktor, pemeran.id_pemeran, pemeran.peran, film.judul_film
                    FROM aktor
                    INNER JOIN pemeran ON aktor.id_aktor = pemeran.id_aktor
                    INNER JOIN film ON pemeran.id_film = film.id_film; ");
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit_data_pemeran.php?id_pemeran=<?php echo $data['id_pemeran']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete_data_pemeran.php?id_pemeran=<?php echo $data['id_pemeran']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
