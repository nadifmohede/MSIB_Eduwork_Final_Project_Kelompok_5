      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Edit Data Genre</h1>
            ...
            <div class="card mb-4">
              <div class="card-body">
                Silahkan isi data dibawah untuk mengedit data genre.
              </div>
            </div>
            <div class="col text-right">
                  <a href="data_genre.php" class="btn btn-dark">Kembali ke Data Genre</a>
                  <br><br>
            </div>
            ...
            $data_genre =mysqli_query($koneksi, "SELECT * FROM genre WHERE id_genre = '$id_genre' ");

            while($genre = mysqli_fetch_array($data_genre)){
                $judul_genre = $genre['judul_genre'];
            }
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="proses_edit_genre.php?id_sutradara=<?php echo $sutradara['id_sutradara']; ?>" method="post">
                        <div class="form-group pb-3">
                            <label>Nama Genre</label>
                            <input type="hidden" name="id_genre" value="<?php echo $id_genre; ?>">
                            <input type="text" name="judul_genre" value="<?php echo $judul_genre; ?>" class="form-control">
                        </div>
                        <div class="form-group pb-3">
